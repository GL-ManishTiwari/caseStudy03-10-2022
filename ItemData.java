...
public class ItemData {
    final static String filePath = "D:/Training/Exam/CaseStudy02/src/SnackItem.txt";
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (status.equals("A")) {
                    String name = parts[0];
                    String rate = parts[1];
                    String discountRate = parts[3];
                    String discountQty = parts[4];

                    SnackItem snack = new SnackItem(name, rate, status, discountQty, discountRate);
